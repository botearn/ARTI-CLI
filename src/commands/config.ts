...
const SECRET_KEYS = new Set(["token", "refreshToken", "artiDataInternalKey", "apiKey"]);
...
function isSecretConfigKey(key: string): boolean {
  return key.endsWith(".token") || key.endsWith(".refreshToken") || key.endsWith(".artiDataInternalKey") || key.endsWith(".apiKey");
}
